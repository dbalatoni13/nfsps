...
[Build Status]: https://github.com/dbalatoni13/nsfps/actions/workflows/build.yml/badge.svg
[actions]: https://github.com/dbalatoni13/nfsps/actions/workflows/build.yml
...
- Clone the repository:
  ...
  ```sh
  git clone https://github.com/dbalatoni13/nfsps.git
  ```

- Copy your game's disc image to `orig/RNPE69`.
...
- Configure:
  ...
  To use a version other than `RNPE69`, specify it with `--version`.
